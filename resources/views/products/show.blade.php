                ...
                <main class="col-lg-6">
                    <h4 class="ps-lg-3">
                        ...
                        @if($product->price)
                            ...
                            <div >
                                <form id="AddtoCart-form" method="POST" action="{{route('cart.store')}}" class="hidden" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <button class="px-4 py-2 primary bg-blue-800 rounded">Add To Cart</button>
                                </form>
